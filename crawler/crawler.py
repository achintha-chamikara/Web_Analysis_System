...
class WebsiteCrawler:
    ...
    def get_page_info(self, url):
        try:
            ...
            response = requests.get(url, timeout=10, headers={
                "User-Agent": "Mozilla/5.0 (WebAnalysisBot/1.0)"
            })
    ...
    def crawl(self):
        print(Fore.CYAN + f"\n{'='*55}")
        print(Fore.CYAN + f"  Website Analysis System - Crawler Engine")
        ...
        while queue and len(self.visited) < self.max_pages:
            ...
            print(Fore.GREEN + f"  [Crawling {len(self.visited)}/{self.max_pages}] " + Style.RESET_ALL + url)
        ...
        print(Fore.CYAN + f"\n{'='*55}")
        print(Fore.GREEN + f"  Crawling Complete!")
